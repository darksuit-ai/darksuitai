...
*/
func AddConversationToMemory(chatMemory *mongo.Collection,sessionId string, prompt string, ai_message string) error{
...
*/
func RetrieveMemoryWithK(chatMemory *mongo.Collection,sessionId string, k int64) (string,error ){
